...
public class HelloTraceV2 {
    ...
    public TraceStatus beginSync(TraceId beforeTraceId, String message) {
        TraceId nexTraceId = beforeTraceId.createNextId();
        Long startTimeMs = System.currentTimeMillis();
        log.info("[{}] {}{}", nexTraceId.getId(), addSpace(START_PREFIX, nexTraceId.getLevel()), message);
        return TraceStatus.builder().startTimeMs(startTimeMs).traceId(nexTraceId).message(message).build();
    }
